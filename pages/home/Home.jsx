...
const Home = () => {
	const [dailyDevotion, setDailyDevotion] = useState({
		title: "And we know that for those who love God all things work together for good, for those who are called according to His purpose.",
			...
			<div className={styles.HomeWrapper}>
				...
				<div className={styles.Center}>
					...
					<section className={styles.Scroller}>
						<h1>{dailyDevotion.title}</h1>

						<p>{dailyDevotion.body}</p>
					</section>
				</div>
